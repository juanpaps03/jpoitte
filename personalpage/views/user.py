...
from personalpage.utils import flash_errors, render_extensions
from personalpage.forms.user import PasswordForm, EmailForm, UsernameForm
from personalpage.extensions import mail
...
def reset():
    ...
    if form.validate_on_submit():
        ...
        from personalpage.settings import Config
